...
in \Sexpr{BiocStyle::pkg_ver("Prostar")}.
\end{abstract}
\packageVersion{\Sexpr{paste(BiocStyle::pkg_ver("Prostar"), "; ", BiocStyle::pkg_ver("DAPAR"), "; ", BiocStyle::pkg_ver("DAPARdata"), sep="")}}
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, compiler, datasets, graphics, grDevices, methods, parallel, stats,
    utils
  \item Other packages: Biobase~2.40.0, BiocGenerics~0.26.0, BiocParallel~1.14.2,
    colourpicker~1.0, DAPAR~1.13.15, data.table~1.11.8, doParallel~1.0.14, dplyr~0.7.7,
    DT~0.4.14, forcats~0.3.0, foreach~1.4.4, future~1.9.0, ggplot2~3.0.0, gplots~3.0.1,
    highcharter~0.6.0, iterators~1.0.10, MSnbase~2.6.2, mzR~2.14.0, promises~1.0.1,
    ProtGenerics~1.12.0, purrr~0.2.5, R.methodsS3~1.7.1, R.oo~1.22.0, R.utils~2.7.0,
    rclipboard~0.1, RColorBrewer~1.1-2, Rcpp~0.12.17, readr~1.1.1, rhandsontable~0.3.6,
    shiny~1.1.0.9001, shinyAce~0.3.2, shinyBS~0.61, shinycssloaders~0.2.0, shinyjqui~0.3.2,
    shinyjs~1.0, shinythemes~1.1.1, shinyTree~0.2.6, shinyWidgets~0.4.3, sm~2.2-5.6,
    stringr~1.3.1, tibble~1.4.2, tidyr~0.8.1, tidyverse~1.2.1, vioplot~0.2
  \item Loaded via a namespace (and not attached): affy~1.58.0, affyio~1.50.0,
    AnnotationDbi~1.42.1, assertthat~0.2.0, backports~1.1.2, bindr~0.1.1, bindrcpp~0.2.2,
    BiocInstaller~1.30.0, BiocStyle~2.8.2, bit~1.1-14, bit64~0.9-7, bitops~1.0-6, blob~1.1.1,
    broom~0.5.0, Cairo~1.5-9, caTools~1.17.1.1, cellranger~1.1.0, cli~1.0.1, cluster~2.0.7-1,
    clusterProfiler~3.8.1, codetools~0.2-15, colorspace~1.3-2, cowplot~0.9.3, cp4p~0.3.5,
    crayon~1.3.4, crosstalk~1.0.0, curl~3.2, DAPARdata~1.11.2, DBI~1.0.0, digest~0.6.18,
    DO.db~2.9, DOSE~3.6.1, enrichplot~1.0.2, evaluate~0.12, factoextra~1.0.5, FactoMineR~1.41,
    farver~1.0, fastmatch~1.1-0, fgsea~1.6.0, flashClust~1.01-2, gdata~2.18.0, geeM~0.10.1,
    geepack~1.2-1, ggforce~0.1.3, ggraph~1.0.2, ggrepel~0.8.0, ggridges~0.5.1, globals~0.12.4,
    glue~1.3.0, gmm~1.6-2, GO.db~3.6.0, GOSemSim~2.6.2, graph~1.58.0, grid~3.5.1,
    gridExtra~2.3, gtable~0.2.0, gtools~3.8.1, haven~1.1.2, hms~0.4.2, htmltools~0.3.6,
    htmlwidgets~1.3, httpuv~1.4.5, httr~1.3.1, igraph~1.2.2, imp4p~0.7, impute~1.54.0,
    IRanges~2.14.10, Iso~0.0-17, jsonlite~1.5, KernSmooth~2.23-15, knitr~1.20, later~0.7.5,
    lattice~0.20-35, lazyeval~0.2.1, leaps~3.0, limma~3.36.2, listenv~0.7.0, lubridate~1.7.4,
    magrittr~1.5, MALDIquant~1.18, markdown~0.8, MASS~7.3-51, Matrix~1.2-14, memoise~1.1.0,
    MESS~0.5.2, mime~0.6, miniUI~0.1.1.1, modelr~0.1.2, multtest~2.36.0, munsell~0.5.0,
    mvtnorm~1.0-8, mzID~1.18.0, nlme~3.1-137, norm~1.0-9.5, openxlsx~4.1.0, pcaMethods~1.72.0,
    pillar~1.3.0, pkgconfig~2.0.2, plyr~1.8.4, png~0.1-7, preprocessCore~1.42.0,
    quantmod~0.4-13, qvalue~2.12.0, R6~2.3.0, readxl~1.1.0, reshape2~1.4.3, rlang~0.2.2,
    rlist~0.4.6.1, rmarkdown~1.10, rprojroot~1.3-2, RSQLite~2.1.1, rstudioapi~0.8,
    rvcheck~0.1.1, rvest~0.3.2, S4Vectors~0.18.3, sandwich~2.5-0, scales~1.0.0,
    scatterplot3d~0.3-41, siggenes~1.54.0, splines~3.5.1, stats4~3.5.1, stringi~1.2.4,
    survival~2.42-6, tcltk~3.5.1, tidyselect~0.2.5, tmvtnorm~1.4-10, tools~3.5.1,
    truncnorm~1.0-8, TTR~0.23-4, tweenr~1.0.0, units~0.6-1, UpSetR~1.3.3, viridis~0.5.1,
    viridisLite~0.3.0, vsn~3.48.1, whisker~0.3-2, withr~2.1.2, XML~3.98-1.16, xml2~1.2.0,
    xtable~1.8-3, xts~0.11-1, yaml~2.2.0, zip~1.0.0, zlibbioc~1.26.0, zoo~1.8-4
\end{itemize}
