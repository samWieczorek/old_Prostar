...
\textcolor{red}{In this step, the user may decide to delete peptides or proteins where the amount of missing values is too important to expect confident processing and if they are tagged as Contaminants or Reverse.}
