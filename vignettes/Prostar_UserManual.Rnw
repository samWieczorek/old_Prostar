...
\caption{Options for the GO analysis.}\label{fig:GO_tab1}
\end {figure}
...
\caption{Perform GO classification}\label{fig:GO_tab2}
\end {figure}
...
\caption{Perform GO enrichment.}\label{fig:GO_tab3}
\end {figure}
