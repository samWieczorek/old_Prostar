...
The right part of the interface is to let the user choose the format of the report; it can be a pdf file, a HTML file or a Word file. He/she has also to specify the name of the file.
