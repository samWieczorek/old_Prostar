...
\begin{itemize}\raggedright
  ...
  \item Running under: \verb|Windows 10 x64 (build 14393)|
  \item Matrix products: default
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Loaded via a namespace (and not attached): backports~1.1.2,
    BiocStyle~2.8.2, compiler~3.5.1, digest~0.6.15, evaluate~0.11,
    htmltools~0.3.6, knitr~1.20, magrittr~1.5, Rcpp~0.12.18,
    rmarkdown~1.10, rprojroot~1.3-2, stringi~1.1.7, stringr~1.3.1,
