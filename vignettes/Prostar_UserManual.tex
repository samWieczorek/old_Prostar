...
Create a directory named \Biocpkg{ProStaR} in the Shiny Server directory with the user shiny as owner and then copy the 3 files: ui.R, global.R and server.R.\newline
