...
spectrometry). \textcolor{red}{The experiment package \Biocpkg{DAPARdata} is the companion package for \Biocpkg{ProStaR} and \Biocpkg{DAPAR}. It contains many datasets that can be used as example.}\newline
...
to be administrated. In that case, \Biocpkg{DAPAR} has to be classically installed 
...
\CRANpkg{data.table}, \CRANpkg{DT}, \CRANpkg{shinyjs}, \CRANpkg{sm}, \CRANpkg{openxlsx},
...
Create a directory named \Biocpkg{ProStaR} in the Shiny Server directory with the user shiny as owner and then copy the Prostar files.\newline
...
\CRANpkg{graphics}, \CRANpkg{utils}, \CRANpkg{parallel}, \CRANpkg{openxlsx}, \CRANpkg{Matrix},
\CRANpkg{highcharter}
...
\textcolor{red}{The installation of the package \Biocpkg{DAPARdata} follows the classical way for Bioconductor packages. In a R console, enter:}
\begin{Schunk}
\begin{Sinput}
> source("http://www.bioconductor.org/biocLite.R")
> biocLite("DAPARdata")
...
the top, a navbar menu helps navigating through the various \Biocpkg{DAPAR} 
...
\begin{itemize}
\item \textbf{Parameter 1: } the centering can operate over the entire dataset (value "overall") or over each condition (value "within conditions"),
\item \textbf{Parameter 2: } include variance reduction
\end{itemize}
...
\begin{itemize}\raggedright
  \item R Under development (unstable) (2017-03-21 r72380), \verb|x86_64-apple-darwin15.6.0|
  \item Locale: \verb|fr_FR.UTF-8/fr_FR.UTF-8/fr_FR.UTF-8/C/fr_FR.UTF-8/fr_FR.UTF-8|
  \item Running under: \verb|macOS Sierra 10.12.4|
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods, stats,
    utils
  \item Loaded via a namespace (and not attached): backports~1.0.5,
    BiocStyle~2.3.31, compiler~3.4.0, digest~0.6.12, evaluate~0.10,
    htmltools~0.3.5, knitr~1.15.1, magrittr~1.5, Rcpp~0.12.10, rmarkdown~1.3,
    rprojroot~1.2, stringi~1.1.3, stringr~1.2.0, tools~3.4.0, yaml~2.1.14
\end{itemize}
