...
\Biocpkg{ProStaR} and giving the followinf permissions:\newline
\shellcmd{sudo cp -R inst/extdata/www /srv/shiny-server/Prostar/.}
\shellcmd{sudo chmod 755 /srv/shiny-server/Prostar/www}\newline
\newline
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods, stats,
    utils
  \item Loaded via a namespace (and not attached): BiocStyle~2.2.0, tools~3.3.2
\end{itemize}
