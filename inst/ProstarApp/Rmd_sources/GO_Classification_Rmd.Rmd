...
knitr::include_graphics(paste(tempdir(), sessionID, gGraphicsFilenames$GOClassificationImg1, sep="/"))
```                                                    
...
knitr::include_graphics(paste(tempdir(), sessionID, gGraphicsFilenames$GOClassificationImg2, sep="/"))
```                                                    
...
knitr::include_graphics(paste(tempdir(), sessionID, gGraphicsFilenames$GOClassificationImg3, sep="/"))
```                                                    
