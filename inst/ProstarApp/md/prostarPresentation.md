### Data management
* **Conversion**: To import a tabulated (CSV, excel) file containing quantitative data and convert it into an MSnset structure.
...
* **Filtering**: To prune the protein or peptide list according to 
                various criteria (number of missing values, character string matching);
