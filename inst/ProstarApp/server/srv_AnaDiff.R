...
#observeEvent(input$AnaDiff_seuilNA,{  rv$widgets$anaDiff$filter_th_NA <- input$AnaDiff_seuilNA})
#observeEvent(input$AnaDiff_ChooseFilters,{ rv$widgets$anaDiff$filterType  <- input$AnaDiff_ChooseFilters})
