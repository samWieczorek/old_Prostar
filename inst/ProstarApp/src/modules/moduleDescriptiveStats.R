...
##
##################################################################################
source(file.path("./src", "modules/Plots/moduleMSnSetExplorer.R"),  local = TRUE)$value
source(file.path("./src", "modules/Plots/moduleGroupMVPlots.R"),  local = TRUE)$value
source(file.path("./src", "modules/Plots/moduleCorrMatrix.R"),  local = TRUE)$value
source(file.path("./src", "modules/Plots/moduleHeatmap.R"),  local = TRUE)$value
source(file.path("./src", "modules/Plots/modulePCAPlots.R"),  local = TRUE)$value
source(file.path("./src", "modules/Plots/moduleIntensityPlots.R"), local = TRUE)$value
source(file.path("./src", "modules/Plots/moduleVarDistPlot.R"), local = TRUE)$value
